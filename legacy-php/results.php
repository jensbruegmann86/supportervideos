...
if ($q === '') {
    die("Bitte einen Suchbegriff eingeben.");
}
...
<body>
    <div class="container text-center">
        ...
        <div class="col-md-10 col-lg-8">
            <div class="card text-bg-light mb-3 text-center">
              <div class="card-body">
                ...
                <div class="row g-3">
                  <div class="col-sm-7">
                    <input type="text" name="q" class="form-control" style="font-size: 1.25rem;" placeholder="Startnummer oder Name" aria-label="Search" required="">
                  </div>
                  <div class="col-sm">
                    <div class="d-grid">
                      <button class="btn btn-primary btn-gkm" type="submit"><strong>Suche</strong></button>
                    </div>
                  </div>
                </div>
      ...
      <div class="row">
        <div class="col pb-2">
            <strong><?php echo $resultCount; ?> Ergebnisse</strong>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-md-10 col-lg-8">
          ...
          <a href="upload.php?key=ASDRFTRA&bib=<?= htmlspecialchars($row['bib']) ?>&sdf=asdrRF" class="btn btn-lg btn-light border border-gkm" style="text-align: left; position: relative; margin-bottom: 15px;">
            ...
            <span class="text-gkm"><strong><?= htmlspecialchars($row["name"]) ?> <?= htmlspecialchars($row["surname"]) ?></strong></span><br><span class="text-gkm-sm"><?= htmlspecialchars($row["bib"]) ?> | <?php if ($row["race"]==1) { echo "Marathon"; } elseif ($row["race"]==2) { echo "Halbmarathon"; } ?></span>
          </a>
          </div>
        </div>
      </div>
